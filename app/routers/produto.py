...
def listar_produtos(
    ...
    offset: int = Query(1, description="Ponto inicial para a paginação")
):
    """
    ...
    return [
        {
            ...
            "likes": produto.likes,
            "slug": produto.slug,
            "tempo_desde_publicacao": calcular_tempo_publicacao(produto.data_publicacao),
            "likei": usuario in produto.usuarios_que_deram_like if usuario else None  # Verifica se o usuário deu like, se fornecido
        }

...
from models import Produto, Usuario, InfoUsuario,Comentario,produto_likes,Seguidor,Notificacao,Anuncio
...
def create_produto_db_with_image(
    ...
    # Dentro da função que publica um produto
...
def weighted_random_selection(produtos: List[Produto], db: Session):
    """
    Seleciona produtos com base em um sistema de pesos calculado por visualizações, likes e se estão promovidos.
